...
- [`dados/pipeline_runs.csv`](dados/pipeline_runs.csv): uma linha por run.
- [`dados/pipeline_metrics.csv`](dados/pipeline_metrics.csv): uma linha por job,
  com campos no formato exigido pela atividade.
- [`dados/step_metrics.csv`](dados/step_metrics.csv): uma linha por etapa.
- [`dados/pipeline_runs.json`](dados/pipeline_runs.json): copia JSON da base de
  runs.
...
![Tempo total do workflow por execucao](graficos/workflow_duration_by_run.png)

### Tempo por job

![Tempo por job em cada execucao](graficos/job_duration_by_run.png)

### Taxa de sucesso e falha

![Taxa de sucesso e falha](graficos/status_rate.png)

### Quantidade de testes vs duracao

![Relacao entre quantidade de testes e duracao](graficos/tests_vs_duration.png)

### Duracao media das etapas relevantes

![Duracao media das etapas relevantes](graficos/average_step_duration.png)
